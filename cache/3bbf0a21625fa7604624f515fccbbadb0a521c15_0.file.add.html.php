...
function content_5f8db673368f98_39016181 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
...
?>
            ...
            <div class="col-md-8 col-xs-8 offset-md-2 latest-post-area pb-120">
                <div class="card text-center">
                    <div class="card-header bg-primary text-white">Ajout d'une Activite</div>
                    <div class="card-body text-dark">
                        <div class="card text-center mb-4">
                            <p><a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
Activite/liste/1" class="btn btn-primary mt-4">Liste des Activités</a></p>
                        </div>
