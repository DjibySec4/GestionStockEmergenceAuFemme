...
function content_5f96a0214d7755_90873224 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
...
?>
            ...
            <div class="col-md-8 col-xs-8 offset-md-2 latest-post-area pb-120">
                <div class="card text-center">
                    <div class="bg-primary text-white" style="height:45px;"><h2>Ajout d'une Nationalité</h2></div>
                    <div class="card-body text-dark">
                        <div class="card text-center mb-4">
                            <p><a href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
Nationalite/liste/1" class="btn btn-primary mt-4"><b><strong>Afficher la liste des Nationalités</strong></b></a></p>
                        </div>
